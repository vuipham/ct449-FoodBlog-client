<!-- <template>
    <form>  
        ...
        <input v-model="user.name" class="form-control mb-2" placeholder="Name" required>
        <input v-model="user.email" type="email" class="form-control mb-2" placeholder="Email" required>
        <input v-model="user.password" type="password" class="form-control" placeholder="Password" required>  
        <button @click="handlerSubmitLogin($event)" class="w-100 btn btn-lg btn-primary" type="submit">Submit</button>
    </form>
</template> -->
     ...
     <main class="form-signin">
         <form>
           ...
           <div class="text-center">
             <button @click="handlerSubmitLogin($event)" type="submit" class="mt-3 w-100 btn btn-primary">Register</button>
           </div>
           <div class="mt-4">        
